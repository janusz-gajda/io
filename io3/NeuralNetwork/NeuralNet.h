...
private:
	...
	ActivationFunction* activefun;

public:
	NeuralNet(vector<int> Topology, double learning_rate, double Accuracy, double Tolerance, bool dropout_method, double dropout_probability, vector<int> LayersToDropout, ActivationFunction* fun);

	NeuralNet(vector<int> Topology, double learning_rate, double Accuracy, double Tolerance, bool dropout_method, ActivationFunction* fun);
