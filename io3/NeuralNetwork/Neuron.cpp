...
void Neuron::Function(ActivationFunction*& active) {
    Output = active->Function(Neuron::Input);
}

double Neuron::Derivative(ActivationFunction*& active) {
    return active->Derivative(Neuron::Input, Neuron::Output);
}
